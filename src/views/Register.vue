                ...
                <form class="pt-3" v-on:submit.prevent="Register">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="file" class="form-control form-control-lg border-left-0" id="foto" name="foto" placeholder="Foto"  required>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control form-control-lg border-left-0" name="no_telp" id="no_telp" placeholder="Nomer Handphone Anda"  v-model="no_telp" required>                        
                    </div>
                  </div>
                  <div class="my-3">
